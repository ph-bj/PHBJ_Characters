...
function getChapterReaderSubtitle(
  chapter: Chapter,
  lang: "en" | "zh",
): string | null {
...
const CHINESE_WORK_BY_ENGLISH_LOWER: Record<string, string> =
  Object.fromEntries(
...
function getCharacterNameForLanguage(
  character: Character,
  lang: "en" | "zh",
): string {
