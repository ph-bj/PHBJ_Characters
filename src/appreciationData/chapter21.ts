...
export const chapter21Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    {
      ...
      descriptionZh: "本章开篇局势：第二十一章：魏聘才得志",
  ...
  dimensions: [
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "魏聘才得志便猖狂的小人嘴脸，与梅子玉因相思而积郁成疾形成鲜明对比。", textEn: "Wei Pincai shows his true petty nature after gaining power; Ziyu languishes in lovesickness." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "权力的异化与求而不得的相思之苦", textEn: "The alienation of power and the torment of unfulfilled love." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“权力的异化与求而不得的相思之苦”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The alienation of power and the torment of unfulfilled love.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
