...
export const chapter23Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    {
      ...
      descriptionZh: "本章开篇局势：第二十三章：李元茂借银",
  ...
  dimensions: [
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "李元茂对金钱的小心翼翼与绝望，凸显了他的处境堪忧。", textEn: "Li Yuanmao's meticulous and desperate handling of money highlights his precarity." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "生活的现实性与财务困境的重压", textEn: "The practicalities of life and the burden of financial struggles." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“生活的现实性与财务困境的重压”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The practicalities of life and the burden of financial struggles.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
