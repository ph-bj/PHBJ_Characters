...
export const chapter27Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    {
      ...
      descriptionZh: "本章开篇局势：第二十七章：魏聘才的勒索阴谋",
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第二十七章：魏聘才的勒索阴谋' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 27: Wei Pincai's Extortion Plot', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "聘才冷酷地策划着巨额勒索，享受着他的残忍。", textEn: "Pincai plots ruthlessly, seeking a massive ransom and enjoying his cruelty." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "不当权力与贪婪的腐蚀力", textEn: "The corrupting influence of unearned power and greed." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“不当权力与贪婪的腐蚀力”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The corrupting influence of unearned power and greed.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
