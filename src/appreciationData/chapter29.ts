...
export const chapter29Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    {
      ...
      descriptionZh: "本章开篇局势：第二十九章：琴言慰子玉",
      descriptionEn: "The situation at the beginning of the chapter.",
    },
    {
      stageZh: "2. 冲突发展", stageEn: "2. Conflict Development", sentiment: 30,
      descriptionZh: "琴言造访梅府，意外受到颜夫人的欢迎并去安慰子玉。",
      descriptionEn: "Qinyan visits the Mei residence and is unexpectedly welcomed by Lady Yan to comfort Ziyu.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第二十九章：琴言慰子玉与夫人的慈悲' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 29: Qinyan Comforts Ziyu', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "颜夫人的仁慈令琴言震惊，他满怀同理心去安慰子玉。", textEn: "Lady Yan's kindness shocks Qinyan, who approaches Ziyu with deep empathy." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "意想不到的慈悲打破了僵化的社会藩篱", textEn: "Unexpected compassion breaking down rigid social barriers." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“意想不到的慈悲打破了僵化的社会藩篱”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'Unexpected compassion breaking down rigid social barriers.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
