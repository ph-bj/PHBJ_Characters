...
export const chapter32Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第三十二章：秋雨连绵与科考之虑' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 32: The Autumn Rain and Exam Anxiety', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "春航与高品饱受失眠与焦虑折磨，展现了他们的脆弱。", textEn: "Chunhang and Gao Pin suffer from insomnia and anxiety, revealing their vulnerability." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "科举制度带来的沉重心理负担", textEn: "The heavy psychological burden of the imperial examination system." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“科举制度带来的沉重心理负担”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The heavy psychological burden of the imperial examination system.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    spaces: [
        {
          id: 1,
          locationZh: "连绵秋雨中的京城", locationEn: "The Capital in Endless Autumn Rain",
          atmosphereZh: "阴郁、泥泞、压抑", atmosphereEn: "Gloomy, muddy, oppressive",
