...
export const chapter34Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第三十四章：巧遇聘才与婚事延宕' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 34: Encounters and Wedding Delays', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "李元茂焦急地寻找聘才帮忙筹办婚礼，暴露出他对不可靠之人的依赖。", textEn: "Li Yuanmao frantically seeks Pincai to help with his wedding, showing his reliance on unreliable figures." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "个人大事与人际债务的混乱交织", textEn: "The chaotic intertwining of personal milestones and interpersonal debts." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“个人大事与人际债务的混乱交织”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The chaotic intertwining of personal milestones and interpersonal debts.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    rumors: [
        {
          id: 1,
          rumorZh: "梅子玉即将在明春成婚", rumorEn: "Mei Ziyu is to be married next spring",
          originZh: "家族内部的书信与李元茂的转述", originEn: "Internal family letters and Li Yuanmao's relaying",
