...
export const chapter35Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第三十五章：失窃疑云与夜半惊魂' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 35: The Stolen Trunk', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "聘才对失窃财富的恐慌暴露了他深层的缺乏安全感与贪婪。", textEn: "Pincai's panic over his stolen wealth reveals his deep insecurity and greed." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "财富的脆弱性与有罪者的偏执", textEn: "The vulnerability of wealth and the paranoia of the guilty." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“财富的脆弱性与有罪者的偏执”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The vulnerability of wealth and the paranoia of the guilty.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    flows: [
        {
          id: 1,
          sourceZh: "魏聘才的私藏", sourceEn: "Wei Pincai's Stash",
          targetZh: "未知的盗贼", targetEn: "Unknown Thieves",
          amountZh: "装满财物的箱匣", amountEn: "Trunks and caskets full of valuables",
