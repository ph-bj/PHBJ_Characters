...
export const chapter38Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  dimensions: [
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "通过审美与文学情谊重塑尊严", textEn: "The restoration of dignity through aesthetic and literary camaraderie." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“通过审美与文学情谊重塑尊严”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The restoration of dignity through aesthetic and literary camaraderie.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    spaces: [
        {
          id: 1,
          locationZh: "梅花庵", locationEn: "Plum-Blossom Hermitage",
          atmosphereZh: "高雅、脱俗、充满文人意趣", atmosphereEn: "Refined, transcendent, filled with scholarly charm",
