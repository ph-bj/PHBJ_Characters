...
export const chapter39Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    ...
    },
    {
      ...
      descriptionZh: "元茂准备婚礼，却将筹备工作交给了焦头烂额的聘才。",
      descriptionEn: "As Yuanmao prepares for his wedding, he entrusts the arrangements to a desperate Pincai.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第三十九章：元茂筹婚与聘才的困境' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 39: Yuanmao's Wedding Preparations', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "元茂将终身大事托付给极度不靠谱且正处于破产困境的聘才。", textEn: "Yuanmao delegates his life event to the deeply unreliable and currently ruined Pincai." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "喜庆的社会仪式与潜在财务破产的碰撞", textEn: "The collision of joyous social rituals with underlying financial ruin." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“喜庆的社会仪式与潜在财务破产的碰撞”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The collision of joyous social rituals with underlying financial ruin.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    dichotomies: [
        {
          ...
          surfaceEmotionZh: "大包大揽的仗义与热络", surfaceEmotionEn: "Overpromising loyalty and enthusiasm",
          hiddenEmotionZh: "因失窃而极度缺钱，试图借操办婚礼从中渔利填补亏空的算计", hiddenEmotionEn: "Desperate for money after the theft, scheming to skim off the wedding funds to cover his losses",
