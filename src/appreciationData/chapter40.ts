...
export const chapter40Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    ...
    },
    {
      ...
      descriptionZh: "十一无法正面报复琴言，便四处散播恶意谎言，同时还要应付家中的麻烦。",
      descriptionEn: "Unable to confront Qinyan, Xi Shiyi spreads malicious lies about him, while dealing with domestic trouble.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第四十章：十一报复与流言中伤' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 40: Xi Shiyi's Revenge and Slander', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "脆弱男子气概与恶意流言的破坏力", textEn: "The destructive power of fragile masculinity and malicious gossip." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“脆弱男子气概与恶意流言的破坏力”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The destructive power of fragile masculinity and malicious gossip.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
