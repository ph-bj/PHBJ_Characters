...
export const chapter48Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    ...
    },
    {
      ...
      descriptionZh: "屈公准备赴任，众人为他和琴仙举办送别宴，同时春航高中状元。",
      descriptionEn: "Master Qu prepares for his new post, and farewell feasts are held as Chunhang becomes Zhuangyuan.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第四十八章：离别之宴与青云直上' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 48: Farewells and High Honors', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "众人庆祝成功的顶峰，却必须面对分离的现实。", textEn: "The group celebrates the pinnacle of success but must face the reality of separation." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "带来必然离别的成功的苦乐参半", textEn: "The bittersweet nature of success that brings inevitable partings." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“带来必然离别的成功的苦乐参半”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The bittersweet nature of success that brings inevitable partings.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    dichotomies: [
        {
          ...
          surfaceEmotionZh: "为朋友高中和义父高升的欣慰与祝贺", surfaceEmotionEn: "Relief and congratulation for friends' success and adopted father's promotion",
          hiddenEmotionZh: "对琴仙即将离京的极度不舍与深切的孤独感", hiddenEmotionEn: "Extreme reluctance to part with Qinxian and a profound sense of loneliness",
