...
export const chapter49Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    ...
    },
    {
      ...
      descriptionZh: "琴仙离去后子玉重病，同时春航试图寻找一位合适的妻子来管理家庭。",
      descriptionEn: "Ziyu falls gravely ill after Qinxian's departure, while Chunhang seeks a suitable wife to run his home.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第四十九章：子玉旧病复发与春航的婚姻困境' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 49: Ziyu's Relapse and Chunhang's Dilemma', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "子玉因悲伤过度而身体崩溃；春航在社会压力下面临续弦的挣扎。", textEn: "Ziyu physically collapses from grief; Chunhang struggles with societal pressure to remarry." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "心碎的生理代价与个人欲望同家庭需求的冲突", textEn: "The physical toll of heartbreak and the clash of personal desire with domestic necessity." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“心碎的生理代价与个人欲望同家庭需求的冲突”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The physical toll of heartbreak and the clash of personal desire with domestic necessity.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizers: [
    ...
    rumors: [
        {
          id: 1,
          rumorZh: "新科状元田春航急需续弦", rumorEn: "The new Zhuangyuan Tian Chunhang urgently needs a new wife",
          originZh: "田老夫人的催促与京城媒婆的走动", originEn: "Madam Tian's urging and the movement of capital matchmakers",
