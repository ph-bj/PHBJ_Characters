...
export const chapter54Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  timelineData: [
    ...
    },
    {
      ...
      descriptionZh: "子玉对着琴言的诗暗自神伤，此时他父亲寄来书信敲定了他成婚的日期。",
      descriptionEn: "Ziyu languishes over Qinyan's poem, just as a letter arrives from his father fixing his marriage date.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第五十四章：子玉相思与包办婚姻' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 54: Ziyu's Lovesickness and the Arranged Marriage', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "子玉因思念琴言而陷入绝望，而他的父亲却从远方操控着他的婚姻。", textEn: "Ziyu is trapped in despair over Qinyan while his father dictates his marriage from afar." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "热烈禁忌之爱与父权责任之间的悲剧冲突", textEn: "The tragic conflict between passionate, forbidden love and patriarchal duty." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“热烈禁忌之爱与父权责任之间的悲剧冲突”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The tragic conflict between passionate, forbidden love and patriarchal duty.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    ...
    dichotomies: [
        {
          ...
          surfaceEmotionZh: "对父亲安排的顺从与无奈", surfaceEmotionEn: "Obedience and helplessness regarding his father's arrangement",
          hiddenEmotionZh: "心如死灰，灵魂仍被远方的琴言紧紧锁住", hiddenEmotionEn: "Heart like dead ashes, soul still tightly bound to the distant Qinyan",
