...
export const chapter58Appreciation: ChapterAppreciationData = {
  radarData: [
  ...
  dimensions: [
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "因果报应与腐败、脆弱财富的迅速崩溃", textEn: "Karmic retribution and the rapid collapse of corrupt, fragile wealth." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“因果报应与腐败、脆弱财富的迅速崩溃”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'Karmic retribution and the rapid collapse of corrupt, fragile wealth.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
