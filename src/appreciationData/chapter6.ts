  ...
  timelineData: [
    {
      ...
      descriptionZh: "本章开篇局势：暗赠珍礼",
      descriptionEn: "The situation at the beginning of the chapter.",
    },
    {
      stageZh: "2. 冲突发展", stageEn: "2. Conflict Development", sentiment: 30,
      descriptionZh: "子玉暗中赠予琴言珍贵的礼物，以减轻他的困境。",
      descriptionEn: "Ziyu secretly bestows a valuable gift upon Qinyan to alleviate his hardships.",
    },
    {
  ...
  dimensions: [
    {
      ...
      subsections: [
        ...
        { labelZh: "情节逻辑", labelEn: "Plot Logic", textZh: "情节围绕 '第六章：暗赠珍礼与情根深种' 展开，结构严密。", textEn: "The plot revolves around 'Chapter 6: The Secret Gift', with a tight structure." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "性格展现", labelEn: "Character", textZh: "子玉使用财富不是为了剥削，而是作为关怀的温柔姿态。", textEn: "Ziyu uses wealth not for exploitation, but as a tender gesture of care." },
    ...
    },
    {
      ...
      subsections: [
        { labelZh: "核心议题", labelEn: "Core Issues", textZh: "礼物语言在弥合巨大阶级鸿沟中的作用", textEn: "The language of gifts in bridging the gap between vastly different social classes." },
    ...
    },
    {
      ...
      subsections: [
        ...
        { labelZh: "时代反思", labelEn: "Modern Relevance", textZh: "即使在2026年审视，本章探讨的“礼物语言在弥合巨大阶级鸿沟中的作用”依然能引起现代人的共鸣，展现了超越时代的文本生命力。", textEn: "Even when examined in 2026, the discussion of 'The language of gifts in bridging the gap between vastly different social classes.' still resonates with modern readers, demonstrating text vitality beyond its era." }
      ]
    }
  ],
  visualizer: {
    type: "wealthFlow",
    flows: [{ id: 1, sourceZh: "梅子玉", sourceEn: "Mei Ziyu", targetZh: "杜琴言", targetEn: "Du Qinyan", amountZh: "珍贵的信物与资助", amountEn: "Precious tokens and financial aid", impactZh: "不同于权贵的买笑，子玉的馈赠是不求回报的灵魂抚慰，加深了二人的情感羁绊。", impactEn: "Unlike the elite buying smiles, Ziyu's gift is unrequited soul-soothing, deepening their emotional bond." }]
  }
};
