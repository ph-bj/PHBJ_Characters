...
export const characterAppearances: Record<
  string,
  Record<number, Array<{ en: string; zh: string }>>
> = {
  "char-0": {
    "1": [
      {
    ...
    "4": [
      {
        en: "Ziyu spends time in his study, the Twenty-Four Qin Chamber, reading and contemplating. He discusses his deep admiration for the actor he saw (Qinguan) with Wei Pengcai, who now speaks highly of him. Later, he receives a letter and poems from Yan Zhongqing about the snow, which he appreciates.",
        zh: "子玉在二十四琴斋读书小憩，与韦聘才谈及对琴言之倾慕，聘才亦盛赞之。后得颜仲清雪中寄诗，甚为赏识。",
      },
    ],
  },
  "char-1": {
    "1": [
      {
        en: "First seen by Mei Ziyu through a carriage window; his extraordinary beauty leaves a lasting impression.",
        zh: "初次登场：在车中被梅子玉瞥见，其绝世容颜令子玉难以忘怀。",
      },
    ],
    "4": [
      {
        en: "Mentioned by Wei Pengcai in conversation with Ziyu as an actor of great talent and character, further fuel for Ziyu's growing obsession.",
        zh: "在韦聘才与子玉的谈话中被提及，称其才貌双全，令子玉愈发神往。",
      },
    ],
  },
  "char-2": {
    "1": [
      {
        en: "The opening chapter sets the stage with a grand taxonomy of Beijing's theater world, classifying both scholar-gentry patrons and celebrated dan performers into ten grades of \\\"feeling\\\" — from the sublime heights of pure-hearted devotion to the murky depths of lust and corruption. Against this backdrop, the protagonist emerges: Mei Ziyu, seventeen years old, son of the distinguished Hanlin academician Mei Shixie. Born after his mother dreamed of a jade-gifting deity, Ziyu has the luminous bearing to match his mythic origin — gifted in learning, unspoiled by wealth, and genuinely innocent amid a household of servants and silk. When his tutor dismisses class for the day, his good friend Yan Zhongqing — nephew of Ziyu's own mother — comes to call. Their easy friendship crackles with warmth, and the conversation turns naturally to the famous performers of the capital's opera houses. In Zhongqing's vivid descriptions, Ziyu catches his first glimpse of a world he has not yet entered — and a longing begins to stir.",
        zh: '全书第一回宏观铺陈，先以评品之眼将京师梨园中的缙绅公子与名旦各分十等，以"情"字为经纬，正者有情中正、情中高、情中逸，劣者则堕入淫、邪、黠、荡之流。随后笔锋一转，引出主角家世：翰林学士梅士燮，三代书香门第，夫人梦授玉郎而生子玉。这梅子玉今年十七，貌如精金良玉，才华横溢，却守身如玉，毫无纨绔气息。一日先生放学，好友颜仲清登门拜访——此人系颜夫人之侄，与子玉情同兄弟。二人相见，话题自然引向京中梨园，仲清口中那些名旦的风姿才情，令子玉心生向往。一场关于"情"的故事，就此悄然揭幕。',
      },
    ],
    "4": [
      {
        en: "An overnight snowfall blankets Beijing in five inches of white — a rare winter gift after months of dry winds. Tutor Li Xingquan, struck by the chill, retreats to bed, leaving Ziyu gloriously unsupervised. He settles into his study, the Twenty-Four Qin Chamber, to read Xie Huilian's classic \\\"Rhapsody on Snow,\\\" then invites Wei Pincai and Li Yuanmao for a snow-viewing feast. Over warm dishes and reluctant cups of wine, he draws Pincai back to the subject of Qinguan, and this time Pincai obliges with lavish praise — the performer's bearing, talent, and character painted in such glowing terms that Ziyu's longing deepens into something close to ache. He imagines meeting such a person amid this crystalline landscape and finds the thought almost unbearably beautiful. After the meal, tea brewed from melted snow sustains the mood. Then a letter arrives from Yan Zhongqing, enclosing a set of eight poems on snowy scenes — composed by Wang Xun and titled \\\"Eight Views from a Snow Window.\\\" Ziyu reads them with delight and immediately begins drafting his own reply, his young scholar's spirit fully alive in the cold bright air.",
    ...
    "9": [
      {
        en: "The Lantern Festival arrives, and Beijing ignites. Wei Pincai and Li Yuanmao quietly clear up the previous night's disaster by borrowing money from the steward and sending it anonymously to their theater contacts. When Ziyu presses them, they produce an alibi and he lets it drop. That evening, with tutor Li and Yuanmao at a guild hall feast and Pincai out sightseeing, Ziyu finds himself at loose ends — until Liu Wenze, Yan Zhongqing, and Wang Xun arrive to sweep him into the festival. The four young men abandon their carriages and walk into the lantern market on foot, swept up in the magnificent chaos of firecracker smoke, silk-curtained carriages, and every variety of lantern imaginable. Then Ziyu is stopped in his tracks — literally blocked by a carriage axle — while a young married woman inside stares at him unblinkingly, shifts her robe to display a silk-slippered foot, and smiles. His companions nudge each other and whisper. When Ziyu finally meets her gaze directly, she smiles again before her carriage glides on. It is a fleeting, wordless exchange — but in this world, such moments carry weight.",
  ...
  "char-3": {
    "5": [
      {
        en: "Chapter Five introduces Xu Ziyun — scion of seven generations of officials, twenty-five years old, holder of a minor ministry post, and possessor of a rare combination of wealth, cultivation, and genuine human warmth. His great project is Yiyuan, the Garden of Contentment: a once-derelict plot of land outside his residence transformed over three or four years, under the supervision of his brilliant friend Xiao Cixian, into a landscape of four hundred rooms, winding streams, and ancient trees that has become the beating heart of Beijing's literati world. Ziyun treasures the famous dan performers of the Flower Register as he treasures rare objects and beautiful flowers — with reverence and care, never with the grasping desire that marks lesser men. The performers sense this and give him their trust completely. When he spots the newcomers Qinguan and Qiguan at a private banquet, he is so enchanted he commissions outfits for them overnight. We also learn Qinguan's history: born Du Qinyan, son of a renowned qin-maker who was beaten to death by a powerful bully, orphaned at ten, and by thirteen compelled by poverty to enter the theater world — a world that has given him fame but cost him everything.",
  ...
  "char-4": {
    ...
    "39": [
      {
        en: "Li Yuanmao's long-deferred marriage to Sun Lianggong's daughter is finally accomplished. Wang Xun manages the logistics; Wei Pincai volunteers as go-between, partly to re-ingratiate himself with Wang Wenhuai. The Yan household lends a pearl coronet and official robes to fill the sixteen betrothal trays with enough borrowed splendour to maintain appearances. On the wedding night, Ziyu, Zhongqing, and Wang Xun join the groom for dinner and exchange mock-solemn verses: Wang Xun wishes him riches to white-haired old age, and Ziyu quotes a comic couplet about a near-sighted man squinting at his new bride. Yuanmao cheerfully declares that near-sightedness has its advantages in the bridal chamber — if she is plain, he will not notice; if she is beautiful, he is robbed. Laughter covers the awkwardness. Drums and pipes welcome the party at the Sun residence. The ceremony is quietly modest; the bride is the first wife's daughter and not especially favoured by her stepmother. Meanwhile, Pincai's earlier visit to the Yan house to pay his respects goes poorly: Ziyu, now aware of what Qinyan suffered through Pincai's connivance, is visibly cooler than before. Old warmth has curdled into polite distance, and under the wedding-night laughter the moral accounting quietly continues.",
  ...
  "char-5": {
    ...
    "3": [
      {
        en: "Wei Pincai misses the household meal and is hospitably invited to eat in the accounts room by the steward Xu Shun. Afterward, idling away the afternoon, he pulls a slim volume from a bamboo bookshelf: the Flower Register, a connoisseur's guide to eight celebrated dan performers. Sprawled on the heated kang, he reads it cover to cover, memorizing each performer's name and described charms, marveling that Beijing's famous beauties might truly live up to their reputations — though in his private heart, none quite displaces the memory of a certain \\\"Qinguan.\\\" The afternoon grows livelier when Ye Maolin arrives with Jin Er, the managing impresario of the Lianjin theater troupe, who has come to negotiate the New Year's banquet booking. A brisk argument ensues over whether the troupe can be \\\"split\\\" between engagements — the steward holds firm to the master's order, and the two parties part to resolve the matter at another household. Left behind, Ye Maolin regales Wei Pincai with vivid tales of theater glamour — the costumes, the performers, the restaurant revelry afterward — and Pincai's hunger for Beijing's pleasures grows nearly unbearable.",
        zh: '魏聘才错过饭点回来，管事许顺热心留他在账房用饭。饭毕无聊，他随手从紫竹书架上翻出一册《曲台花选》，躺在炕上细细研读，将八位名旦的姓名才貌一一默记，心中暗叹京城名旦果然名不虚传——比起他心里念念不忘的"琴官"，也未必相让。正想着，叶茂林领着联锦班大掌班金二爷一同到访，原来是来替正月初五的堂会戏跑腿定档期的。许顺往来周旋，金二坚持要分包，许顺以梅大人之命回绝，双方相持不下，最终约定去王大人府上再商议。叶茂林留下等候，与聘才闲谈，将戏园子里的排场、行头、相公的风姿与馆子里的热闹情形说得绘声绘色，聘才听得心痒难挠，对这花花京城的向往愈发炽烈。',
      },
    ],
    "8": [
      {
        en: "Ziyu returns from his dinner to find Wei Pincai and Li Yuanmao long gone. The two had seized their opportunity the moment he left: Pincai talked Yuanmao into raiding his father's strongbox for eight or nine taels of silver, and they headed straight for the Lianjin troupe at Taihe Garden. Yuanmao's entrance to the theater world is literally face-first — he trips over a bench at the gate and is hauled upright by a stranger who turns out to be Hua Guangsu, a name that will cast a long shadow. Inside, the world Pincai has been dreaming of opens up around them: privileged seats, laughing performers clustering close, wine and perfume and the sweet chaos of the backstage world. At the restaurant afterward, Pincai is in paradise. The reckoning comes at the bill — their money has vanished somewhere between the theater and the table, and the two find themselves scrambling. The chapter cuts between their misadventure and the theater's other dramas, sketching the full cast of patrons and performers whose intersecting desires will drive the story forward.",
    ...
    "18": [
      {
        en: "Qinyan remains confined by illness, sending away all visitors. Ziyu calls at his lodgings but is repeatedly turned away — the tutor is entertaining, or there is business, or the moment is simply wrong. Each missed encounter deepens the ache on both sides, though neither yet knows how close the other has come. The narrator uses the pause to deliver a caustic digression on the four stages of a theatre master's career: the coveted boy, the preening adult, the exploitative master, and finally the degraded bit-player — a lifecycle of use and discardment painted in bitter strokes. Wei Pincai, meanwhile, wanders out of the city in low spirits and falls in with the worldly Zhang Zhongyu, who treats him to wine and a lecture on social survival: ten qualities required of a second-rank gentleman (all modified by 'but not'), and a wry shorthand for the third rank. Pincai laughs and admits he barely qualifies for the third. The chapter balances romantic longing with satirical comedy, mapping a city where feeling and calculation run in parallel streams.",
        zh: '琴言病体未痊，闭门谢客，子玉屡次登门皆未能相见，两人各自悬念，情愫在缺席中愈发深浓。作者借此插入一段对梨园师傅\\"兔、狐、虎、狗\\"四变的犀利讽刺，将剥削相公的师傅们刻画得入木三分。魏聘才进华府后一事无成，某日出城偶遇张仲雨，二人在酒楼小酌，仲雨借机传授\\"处世十样要诀\\"与\\"三等人七字诀\\"，言语诙谐，机锋暗藏。聘才听得若有所悟，却又自知学不全，只得苦笑。这一章于儿女情长之外，别开生面，以讽喻笔法勾勒出京师社会的多重面貌。',
      },
    ],
    "21": [
      {
  ...
  "char-7": {
    ...
    "11": [
      {
        en: "Returning home after seeing Mei Ziyu off, Xu Ziyun recounts to his wife Yuan the tender bond between Ziyu and Qinyan. When Yuan wonders aloud what advantage these dan performers hold over her own lovely maids, Ziyun offers a studied defence: they possess the face of a woman yet the body of a man, pleasing the eye while stilling desire — the best of both worlds. The next day Yuan herself rides out in silks and furs to the birthday banquet of Hua Guangsu's wife, Lady Su Huanxiang. The Hua household dazzles: Lady Su is peerless in beauty and accomplishment, attended by ten maids each named with the character for 'pearl.' Among games, poems, and drinking forfeits the ladies hold elegant court, while the maids create cheerful mayhem. Hua Guangsu himself is introduced — twenty-one, accomplished in archery, verse, and aristocratic leisure, outwardly pure yet surrounded by wealth and power that will shadow everyone around him.",
        zh: '徐子云归宅，与袁夫人谈及梅子玉与琴言的深情，袁夫人将相公们与自家丫鬟相比，子云则娓娓辩称这些少年\\"面有女容、身无女体\\"，可娱目而制心，两全其美。次日袁夫人携六红盛妆赴华光宿夫人生日之宴，珠光宝气，香车如云。华府中苏浣香才貌双绝，十婢皆以\\"珠\\"为名，府邸的繁华令人目眩。席间诸夫人小姐行酒令，俏婢们争相搅闹，热闹至极。华公子年方二十一，骑射词赋皆精，养尊处优，气焰虽豪而性情纯粹——这位令人忌惮的人物就此登场，为后续风波埋下伏笔。',
      },
    ],
    "17": [
      {
  ...
  "char-8": {
    ...
    "10": [
      {
        en: "After the lantern festival, Chapter Ten turns to the hidden currents running beneath Yiyuan's gracious surfaces. Du Qinyan — Qinguan — has been a fixture of the garden's gatherings since arriving in Beijing, cherished by Xu Ziyun above almost all others. But Ziyun has only ever been half a confidant to him, because Qinyan's deepest feelings belong to a person he saw first in a dream: the young man who rescued him from a pit, and whom he recognized in waking life on the road to Beijing. The dreams keep returning — sometimes laughing together, sometimes weeping, sometimes a tender farewell — and each morning he wakes more entangled. When Xiao Cixian reports that Mei Ziyu solved Qinyan's lantern riddle and spoke of him with admiration, Ziyun is delighted and makes an offhand joke about finding Qinyan a \\\"match\\\" — which reduces Qinyan instantly to tears, his voice shaking as he begs only not to be humiliated. Ziyun retreats, abashed. It is Yuan Baozhu who soothes him — and who quietly mentions that a young man named Mei Yuexiang asked after him specifically. Qinyan goes still. He asks, very carefully: was this Mei Ziyu the one watching from the east gallery at the Suzhou Guild Hall? The answer he is waiting for has almost arrived.",
        zh: '元宵灯会之后，怡园这边另有一番情愫暗涌。琴言自去年进京，随众名旦常往怡园，深受子云优待，却始终只把他当半个知己——因为他心上真正挂念的，是那个在进京途中梦中救过他的人。几番梦境，或与子玉相对而笑，或执手同哭，醒来怅然若失。一日子云归园，萧次贤讲起灯谜之夜子玉猜中了琴言的谜，大赞其才貌，子云听了亦颇赞许，道两家本有世谊，随口说要替琴言"觅着配对"。这句玩笑话却把琴言吓得泪如雨下，激切道只求不被人糟蹋，何来配对之说？子云自知失言，忙叫宝珠好言相劝。待宝珠轻轻道出梅庾香问起他的消息，琴言心下一动，细细追问：这位姓梅的，可是那日在姑苏会馆楼上看戏的那个人？一缕暗藏已久的幽情，就此浮出水面。',
      },
    ],
    "17": [
      {
  ...
  "char-9": {
    ...
    "50": [
      {
        en: "Midsummer in the capital: the heat sits on the city like a lid. Tian Chunhang is promised in marriage to Minister Su's second daughter, the wedding fixed for the Double Seventh. Liu Wenze, newly posted to the Board of Personnel, drops in on Lin Chunxi while making his rounds—more from habit than any urgent errand. He finds Chunxi in a state of cheerful self-improvement. The banana plants in the rear courtyard have been pressed into service as a practice surface: both sides of every broad leaf are covered in calligraphy of varying sizes, written, wiped clean, and written again. A small pavilion shades the front yard; miniature landscapes crowd the windowsills. Then Chunxi produces a round fan and holds it up—a mantis seizing a cicada, wings splayed, eyes bulging with predatory intensity, rendered with a confidence that stops Wenze mid-sentence. Chunxi has been studying painting in secret for months, learning from Xiao Cixian's drafts and ignoring the condescension of a rival performer who refused to share technique. The fan changes hands over token protests. Intelligence and aesthetic ambition, the novel suggests, flourish quietly even in the hottest, most distracted season.",
  ...
  "char-21": {
    "51": [
      {
        en: "The Sun brothers sit for the Tongzhou prefectural examinations, each by dishonest means: Sun Sihui hires a ghostwriter while the hapless Sun Siyuan scrawls sheer gibberish on his paper. When the examiner publicly mocks the chaotic script, Sihui strides forward and, with breathtaking cheek, offers an elaborate medical excuse for his brother's incoherence — reducing the entire hall to helpless laughter before being rebuked as a madman himself. Meanwhile Yuan Mao passes with a bare minimum of effort and, newly married and content, strolls the Grand Canal bank at dusk among grain barges and street vendors. The comic farce of the examination hall gives way to the lazy hum of everyday life, painting a vivid portrait of a society where money, connection, and bare-faced audacity count for far more than genuine learning.",
  ...
  "char-31": {
    ...
    "28": [
      {
        en: "Cornered at last, Changqing escorts Du Qinyan to the Hua mansion and presents him without asking a fee — a calculated gesture that flatters the master while securing future goodwill. Hua Guangsu examines Qinyan with undisguised satisfaction; even the usually reserved Madam Hua pronounces him pleasing. Qinyan settles into the Liuqing Study and comports himself with dignified silence, meeting Wei Pincai's occasional glances with the expression of a woman who will not speak her resentment. On the eve of his transfer, Qinyan entrusted to Sulan a small parcel: a handkerchief stained with his own tears and four medicinal herbs — no letter, just objects — to be placed in Ziyu's hands. When Ziyu calls on Sulan days later, still ignorant of everything, he finds Lanbo and Qiguan there and cannot understand why Sulan looks at him with such troubled eyes. The discovery that Qinyan has vanished into the Hua compound — separated by little more than a city wall, yet entirely out of reach — lands with quiet devastation.",
  ...
  "char-33": {
    "40": [
      {
        en: "The moral ledger begins at last to balance. Xi Shiyi, who engineered Du Qinyan's entrapment in Hua's household, has meanwhile exhausted the patience of every companion he has kept. His discarded partners Ba Yingguan and Spring Orchid compare grievances in private, cataloguing his habitual cruelties: the toy-box device with an internal lock that trapped two hands inside and left victims helpless, which victimised unknown numbers of young men before it was finally confiscated and smashed. They wonder aloud when heaven will call in the debt. Heaven obliges shortly afterward, in a manner both apt and undignified: sneaking alone into the temple to molest the sleeping young attendant De Yue, Xi Shiyi finds his advances interrupted by a sudden and violent bout of De Yue's stomach trouble. The scalding, malodorous eruption sends Xi Shiyi scrambling backward in total humiliation — his lust doused as thoroughly as any bucket of cold water could manage. Pan Qiguan, whose habit of haunting the temple gambling tables has accumulated unpayable debts, fares no better: his creditors finally corner him and administer a comprehensive beating. Two villains, two perfectly calibrated degradations — one drenched in filth, one battered black and blue — as the novel signals, with some relish, that accounts will be settled.",
  ...
  "char-40": {
    "57": [
      {
        en: "October brings a different kind of gathering to the Yi Garden. Yuan Qixiang, wife of Xu Ziyun, hosts six of Beijing's most accomplished ladies for a chrysanthemum party in the Precious Fragrance Hall: the Su sisters, the wives of Liu Wenze, Yan Zhongqing, Mei Ziyu, and Wang Xun arrive in a procession of sedan chairs, perfume, and laughter. The hall is transformed — silk cushions, silver screens, seven tiers of blazing chrysanthemums in every colour. Over warm wine the women bond with the ease of old friends discovering they were always meant to meet: they form a sworn sisterhood modelled on the Seven Sages of the Bamboo Grove, rank themselves by age, pledge to abandon all deference to seniority, and rename each other with sisterly familiarity. Poetry contests, shared compositions, and gentle teasing fill the afternoon; the scene shimmers with a rare sense of women fully in possession of their own wit and world.",
  ...
  "char-48": {
    ...
    "6": [
      {
        en: "The New Year social season unfolds in Chapter Six. Mei Shixie receives an invitation to the usual cohort banquet — only twelve guests this year, the list shortened by postings and absences — while Lady Yan holds her own gathering for the women of connected families. The two Mrs. Lu sisters, married into the Wang and Sun households respectively, are the social anchors of the scene: both middle-aged, both still handsome, and possessing very different domestic circumstances. The chapter's sharpest observations are reserved for the Sun family's daughters-in-law: the gentle, scholar-bred Shen Yunggu, trapped with the repulsive Xie Hui and driven to the desperate expedient of offering her own maid as a concubine just to buy herself some peace; and the fierce, soldier-raised Ba Laifeng, married at seventeen to Xie Yuan, burning with a temperament that refuses to be quietly extinguished. Against the bright lanterns and New Year formalities, these women's quiet suffering and dark humor illuminate the cramped realities behind the elegant facades of Beijing's official households.",
  ...
  "char-86": {
    ...
    "29": [
      {
        en: "Lady Yan, learning Qinyan has come, sends him into Ziyu's sickroom to offer comfort. Qinyan approaches the curtained bed with a trembling heart and finds Ziyu alarmingly gaunt — the sight breaks the dam and tears fall onto the sleeping man's face. Ziyu stirs but does not wake; instead he murmurs lines from 'The Song of Everlasting Regret,' dreaming he is already reunited with Qinyan at Sulan's courtyard under a Mid-Autumn sky. He chuckles, mutters a herb prescription, frets about rain and a distant boat — the shards of weeks of feverish longing made audible. Qinyan weeps in silence, unable to call his name aloud with Lady Yan listening at the wall. Wei Pincai finally props Ziyu up and wipes his face with a hot cloth. Ziyu opens his eyes, sees Qinyan, and — convinced this is another cruel illusion — laughs coldly and turns away. Only when Qinyan shifts into the light and his features become unmistakable does Ziyu's resistance collapse. He reaches out; Qinyan takes his hand. Neither speaks. Lady Yan outside begins to cry.",
        zh: '颜夫人得知琴言登门，命其入内安慰病中的子玉。琴言战战兢兢走近床边，见子玉黄瘦憔悴，不禁泪如泉涌，滴落子玉脸上。子玉却在梦呓中念出"七月七日长生殿"，以为已在素兰处与琴言相会，欢喜自语，半醒半睡间又嘟囔着药方、大雨与船——全是相思入骨的梦境碎片。琴言泣不成声，屡唤不应。颜夫人在隔壁听得肝肠欲断。聘才扶起子玉净脸，子玉睁眼初见琴言，以为又是试探，冷笑拒认；待琴言侧身对光，子玉才如梦初醒，两人执手，悲喜交集，难以言表。',
      },
    ],
    "39": [
      {
  ...
  "char-141": {
    "46": [
      {
        en: "Scholar Qu Daoweng takes up residence in the Garden of Ease and formally adopts Qinyan as his son, renaming him Qinxian. From dawn to dusk he teaches classical texts, poetry, calligraphy, and the rhythms of parallel prose. Qinxian proves a scholar's dream: he memorizes on first reading, asks questions that go straight to the marrow of a passage, and practices his brushwork long after his teacher has retired for the night. Within a fortnight the transformation is visible. Qu Daoweng also composes a preface for the garden—a piece of such lapidary elegance that Xu Ziyun immediately commissions a stone engraving. On the twenty-eighth day of the month Ziyun throws open the garden gates for a grand literary gathering. The scholars rename the main tower Cishulou, the Tower of Imperial Books, and Daoweng brushes a paired couplet that sweeps from the thirteen classics to twenty-two philosophical masters, from ten thousand li of landscape to five thousand years of history. The assembled company falls silent, then breaks into applause.",
        zh: '屈道翁入住怡园，收琴仙为义子，日授诗词文章，晨昏对课，父慈子孝，竟如亲生。琴仙天资聪颖，过目成诵，半月之内文理大进。道翁为园作序，文采斐然，子云喜而欲勒石永存。二十八日，子云大开园会，诸名士齐聚含万楼，道翁改楼名为"赐书楼"，并题长联，语惊四座。众人分题赋对，赞颂园景，觥筹往来，笑语盈园。雅集之乐，至此达于鼎盛。',
      },
    ],
    "48": [
      {
    ...
    "55": [
      {
        en: "The journey south unfolds like a classical scroll, beautiful and melancholy in equal measure. Du Qinyan travels with Dao Weng along the Grand Canal, passing the ruins of the Little Rainbow Garden where elegant banquets were once held among famous poets — now nothing but collapsed walls, weeping trees, and the clatter of cicadas. At the Lotus Bridge two bold merchant wives on a pleasure boat toss a bundle of fruit across the water at the pretty young traveller; Dao Weng laughs at the classical allusion — 'pelting the handsome man with fruit' — while Qinyan blushes crimson and refuses to eat a single bite. In Nanjing, drawn by the oracle's words, Qinyan slips away to Mochou Lake and finds the lonely, unmarked grave of the lady Du — a red-clad spirit half-glimpsed in the light. The encounter leaves him trembling with something between recognition and dread.",
        zh: "琴言随道翁顺运河南下，途经小虹园、莲花桥，扬州旧日繁华已是一片废墟荒草，触目惊心。平山堂附近游船上，两个盐商家的妇人抛来一包果品，引得道翁笑称'安仁掷果'，琴言羞红了脸。抵达南京，琴言只身前往莫愁湖，寻访杜仙女墓，荒冢红衣，玄机隐现，令他心中久久难平。这一路山水诗情与感伤交织，宛若一幕幕画卷缓缓展开。",
      },
    ],
    "56": [
      {
        en: "A fall on deck breaks more than Dao Weng's body. In Nanjing, confined to a rented temple room, the old man's long-suppressed illness — years of passionate writing and hard drinking distilled into ruin — surges back. He coughs blood. He loses hours. Contrary winds pin the boat at Yanzi Cliff for days; Qinyan writes letter after letter at his guardian's dictation, then lies awake at night composing a lyric reply to Mei Ziyu's verses, choosing each word with aching care. When they move into the Huguo Temple, Qinyan tends Dao Weng through the long nights, burning incense before the shrine and praying — in words the novel records with quiet reverence — to die in the old man's place. Dao Weng, drifting in and out of lucidity, hears him and weeps: the boy has no one; what will become of him when the end comes?",
