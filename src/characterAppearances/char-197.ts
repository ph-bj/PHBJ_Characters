// Character: 季十矮子 Jì Shí Ǎizi (Ji Shi the Dwarf)
// Chapter Appearances: 46, 47, 60
...
export const char_197Appearances: Record<number, SceneBullet[]> = {
  ...
  60: [
    {
      en: "Arranged by Jin Jifu to find skilled artisans and oversee the carving of the ten flower deity portraits and steles for Nine-Fragrance Garden.",
      zh: "受金吉甫吩咐寻找工匠，负责在十余天内将九香园的十幅花神像与诗传刻于石碑之上。"
    }
  ]
};
