...
export const char_4Appearances: Record<number, SceneBullet[]> = {
  ...
  "10": [
    {
      en: "Mentioned as one of the scholars Ziyun tries to visit, but he is not at home.",
      zh: "子云试图拜访的名士之一，但未能在其住处寻见。",
    },
  ],
  "12": [
    {
  ...
  "13": [
    {
      en: "Indirectly mentioned as having prepared a hundred taels of silver which Zhongqing delivers to Chunhang.",
      zh: "间接提及他准备了百两白银，由仲清转交给春航作为薪水。",
    },
  ],
  "14": [
    {
  ...
  "15": [
    {
      en: "Meets with Nanxiang and Zhongqing to discuss Chunhang's romantic affairs, and later helps see off Mei Shixie as he leaves the capital.",
      zh: "与南湘、仲清会面讨论春航的情感琐事，随后一同送别离京的梅士燮。",
    },
  ],
  "17": [
    {
      en: "Participates in the planning of a grand literary gathering, discussing the guest list and observing Chunhang's disciplined romantic life.",
      zh: "参与筹办盛大的文人雅集，商议宾客名单，并旁观春航受约束的感情生活。",
    },
  ],
  "20": [
    {
  ...
  "25": [
    {
      en: "Mentioned as one of the familiar guests invited by Ziyun to a gathering celebrating Liu Wenze's return.",
      zh: "作为子云邀请的熟客之一，参加了庆祝刘文泽归来的聚会。",
    },
  ],
  "28": [
    {
      en: "Frequently visits the Mei household with Zhongqing to check on Ziyu during his severe illness, offering comfort despite being unable to cure him.",
      zh: "在子玉病重期间，与仲清频繁拜访梅府探望，虽无法治愈其心病，但尽力宽慰。",
    },
  ],
  "29": [
    {
      en: "Questioned by his father Wang Wenhui regarding Ziyu's romantic affairs, but answers vaguely to protect his cousin.",
      zh: "被父亲王文辉盘问子玉的感情琐事，但他含糊其辞以保护表弟。",
    },
  ],
  "30": [
    {
  ...
  "32": [
    {
      en: "Mentioned as forming a closer friendship with Chunhang after the latter achieves academic success.",
      zh: "春航高中后，与他的世交情谊更加深厚。",
    },
  ],
  "35": [
    {
  ...
  "39": [
    {
      en: "Tasked by his father with arranging Li Yuanmao's wedding, he helps host the banquet and playfully observes the chaotic bridal chamber.",
      zh: "受父亲之命代办李元茂的婚事，协助主持喜宴，并在一旁打趣混乱的闹洞房。",
    },
  ],
  "43": [
    {
      en: "Briefly mentioned by Sulan as someone she spoke with regarding Qinyan's affairs.",
      zh: "素兰简短提及曾与他交谈关于琴言的事宜。",
    },
  ],
  "45": [
    {
      en: "His name (Yong'an) appears in the spirit-writing poetry during Ziyun's early morning gathering.",
      zh: "在子云清晨举办的雅集上，其号（庸庵）出现在扶乩的诗句中。",
    },
  ],
  "46": [
    {
  ...
  "48": [
    {
      en: "Keeps Ziyu at his home after a birthday celebration, and later joins the group to see off Daoweng.",
      zh: "在寿宴后将子玉留宿家中，随后与众人一同去给道翁送行。",
    },
  ],
  "50": [
    {
  ...
  "51": [
    {
      en: "His wife stays at her mother's home while her family leaves the capital, and he later lends forty taels of silver to a desperate Yuanmao to clear his debts.",
      zh: "其妻在娘家离开京城时留下居住；他随后借给走投无路的元茂四十两银子以清偿债务。",
    },
  ],
  "52": [
    {
  ...
  "57": [
    {
      en: "His wife, Sun Peiqiu, is invited to a grand gathering of the scholars' wives hosted by Ziyun's wife.",
      zh: "其妻孙佩秋受邀参加徐子云之妻举办的盛大女眷聚会。",
    },
  ],
  "60": [
    {
