  ...
  return (
    <div ref={rootRef} className="relative inline-block">
      <button
        ...
        className="flex items-center gap-1.5 px-2 py-1.5 rounded-sm border border-[var(--paper-border)] bg-[var(--paper-bg)]/80 text-[var(--ink-dim-text)] hover:bg-[var(--accent)]/10 hover:text-[var(--accent)] transition-colors text-xs font-bold uppercase tracking-wider touch-manipulation"
      >
        <Quote size={12} />
            ...
            <div key={style}>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-bold uppercase tracking-wider text-[var(--ink-dim-text)] hover:text-[var(--accent)] transition-colors touch-manipulation"
                >
              ...
              <p className="text-xs leading-snug text-[var(--ink-title)] select-all break-words">
                {text}
              </p>
            </div>
          ))}
