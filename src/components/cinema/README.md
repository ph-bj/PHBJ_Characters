...
- **Writing is special.** Draw every character in `WRITING_INK` (from `cinemaKit`): the ink pass
  recognises its faint blue excess and prints it as solid ink with no brush outline beside it. Put
