 ...
 *
 * Staged from tableau beats (cinema/beats/tableau.ts): a memorial arch to Zhongqing’s mother, his upbringing, Nanxiang’s portrait, and the two cousins compared.
 */
