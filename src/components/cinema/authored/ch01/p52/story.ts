 ...
 *
 * Staged from tableau beats (cinema/beats/tableau.ts): Ziyu’s cart rolling home, two carts wedged in the street, and the view through the glass window.
 */
