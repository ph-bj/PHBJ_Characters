 ...
 *
 * Staged from tableau beats (cinema/beats/tableau.ts): Ziyu’s cart going on through the street, and the boy imagined in the Guanghan palace.
 */
