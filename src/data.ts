...
char-7	徐子云 Xú Zǐyún	度香	26	"Zhejiang, Shanyin"	scholar	ch.4	The generous and refined owner of the Garden of Contentment; a key patron of the arts. He treats performers with respect and redeems Qinyan in ch. 43.	怡园主人，慷慨儒雅的名士领袖。对伶人以礼相待，第43回斥巨资为琴言赎身。
char-8	萧次贤 Xiāo Cìxián	静宜	32	"Hunan, Xiangtan"	scholar	ch.5	Xu Ziyun's closest friend; polymath; designed the Garden of Contentment. A detached and brilliant scholar who offers artistic guidance to many.	徐子云的挚友，博学多才，亲手设计了怡园。为人淡泊名利，常为众人提供艺术指引。
...
char-11	张仲雨 Zhāng Zhòngyǔ	—	~22	Yangzhou	scholar	ch.6	Nephew of Grand Secretary Wu; versatile; goes by '二老爷'; frequents the Garden of Contentment (ch.8)	吴阁学之侄；多才多艺；人称“二老爷”；常出入怡园。
...
char-36	四喜 Sìxǐ	Sixi / Si Xi	—	—	performer	ch.4	Jianchun troupe; seen in ch.4 tavern scene	建春班；第4回出现在酒楼场面。
...
char-44	小顺儿 Xiǎo Shùn'ér	Xiaoshun'er / Xiao Shun'er	—	—	performer	ch.5	十不闲 drum performer; brought by Fu Lun; rejected by Hua Guangsu with contempt	“十不闲”鼓手；富伦带来；遭华光宿蔑视拒绝。
...
char-66	田状元 Tián Zhuàngyuán	Tian the zhuangyuan / Zhuangyuan Tian	—	—	official	ch.49	Top imperial exam graduate; proposes marriage in ch.49	状元；第49回提亲。
...
char-71	掌山西道陆 Director Lu	Director of the Shanxi Circuit / Circuit Censor for Shanxi Lu / Censor Lu	—	—	official	ch.6	Listed among the twelve fellow-provincials at the ch.6 New Year gathering; the Shanxi-circuit censorship is Lu Zongyuan's post (ch.2), so this roll entry is the same man	第6回团拜知单十二位同乡之一；掌山西道即第2回“监察御史陆宗沅”的职衔，与陆宗沅实为一人。
...
char-95	玉天仙 Yù Tiānxiān	Yutianxian / Yu Tianxian	27	—	female	ch.18	Courtesan married by Wei Pincai in ch.50 after he helps revise opera texts	妓女；魏聘才改写剧本后娶其为妻。
...
char-101	石氏 Shí Shì	Lady Shi	28	—	female	ch.58	Pan Qiguan's wife, née Shi; handsome and wayward; central to the scandalous turmoil of ch.58	潘其观之妻石氏，年二十八，颇有姿色而情性风骚；第58回淫乱风波的中心人物。
...
char-108	书房双书僮 Shūfáng Shuāng Shūtóng	书僮 / 书童 / Study Boys / study boys / Page Boys / page boys / study-boy / study boy / page boy	—	—	servant	ch.4	Two unnamed study boys; wait outside the study; serve tea and pour water.	书童；在书房外候着；端茶倒水。
...
char-119	卢大爷 Lú Dàyé	Master Lu	—	—	servant	ch.5	Hua Guangsu's stable and livestock manager; oversees 100+ horses and 70–80 large mules	华府马房总管；管理百余匹马。
...
char-134	刘喜 Liú Xǐ	—	40+	—	servant	ch.38	Loyal longtime attendant to Qu Daoweng; protects and supports Qinxian through illness, theft, funeral rites, and return arrangements	屈道生的老仆；在重病、失窃、丧事与返京过程中始终尽心扶持琴仙。
...
char-151	蔡某 Cài Mǒu	surnamed Cai	—	—	minor	ch.35	Named suspect in temple theft-related incident chain; appears in the investigation and blame-casting context	寺中失窃事件链条中的具名嫌疑角色，出现在追查与归责语境中。
...
char-162	乌大傻 Wū Dàshǎ	大傻 / 大傻子 / Big Fool / Wu Dasha	~30	—	minor	ch.30	Wealthy simpleton of the idle-rich circle; brother-in-law of Gui Zirong; tried in the forged-deed case (ch.32) and joins Ji Liangxuan's tea-house fleecing of Qinyan (ch.42)	纨绔圈中的有钱蠢汉；归自荣的姻亲；第32回卷入假契案受审，第42回与姬亮轩同去打茶围诓骗琴言。
...
char-182	杨八 Yáng Bā	Yang Eight / Yang the Eighth / Master Yang the Eighth / 杨八爷 / 杨梅窗	—	—	minor	ch.16	The 'Eighth Master Yang' of the Fu Lun and Xi Shiyi circle; ch.16 gives his style name as Meichuang and his rank as eighth, and ch.47 states it outright — 'a Master Yang the Eighth, called Meichuang' — so this is Yang Meichuang	富伦、奚十一交游圈中的“杨八爷”；第16回言其“号梅窗，行八”，第47回更明说“一个杨八爷，叫梅窗”，与杨梅窗实为一人。
...
char-188	田太夫人 Tián Tàifūrén	田老太太 / Old Madam Tian / Madam Tian	—	—	female	ch.48	Tian Chunhang's mother; brought to the capital after his success (ch.48); presides over the wedding-season gatherings (ch.52)	田春航之母；第48回被接进京，第52回操持喜庆宴集。
char-189	缝穷婆 Féngqióng Pó	缝穷婆 / 缝穷的 / the mender / mender	—	—	female	ch.51	The mending-woman outside the theatre wall; her quarrel over pilfered coppers sets off the ch.51 street brawl	戏园墙外的缝穷婆；第51回因铜钱失窃与人争闹，引出隔墙听戏一场风波。
...
char-194	黄掌柜 Huáng Zhǎngguì	黄掌柜 / 春阳馆掌柜 / Manager Huang	—	Beijing	minor	ch.8	Manager of Chunyang Restaurant who greets patrons, gets into a dispute with Wei Pincai over unpaid bills, and later co-founds Anji Hall with Monk Tang.	春阳馆掌柜；后与唐和尚合伙开安吉堂。
...
char-197	季十矮子 Jì Shí Ǎizi	季十 / 季矮子 / Ji the Tenth	—	Beijing	minor	ch.46	Skilled stone and wood carver/engraver recommended by Jin Jifu; engraved Qu Daoweng's calligraphy for Garden of Contentment screens in ch.46-47 and arranged stone carvers for Jiuxiang Garden steles in ch.60.	精明熟练的刻工/石刻匠人；金吉甫推荐；第46-47回在怡园刻含万楼屏风，第60回负责找人雕刻九香园十图石碑。
...
char-210	王胡子 Wáng Húzi	王髯 / Wang the Bearded / Wang Ran / Old Wang Beard / Old Wang	50+	—	minor	ch.45	Travelling antiquary with a beard to his waist who claims twenty years and fourteen provinces on the road; he presides as master of the altar at the Garden of Contentment planchette séance whose verdicts disclose the company's former lives, and sells Xu Ziyun the Gujin Tushu Jicheng (chs.45–46)	须垂至腹的行商古董客，自言二十年走过十四省；第45回在怡园含万楼主持扶乩仙坛，判词道破众人前生，第46回将《图书集成》装了五大车送进怡园。
...
char-222	花三胡子 Huā Sān Húzi	花三 / Hua the Third	—	—	minor	ch.32	Father of Hua Zhonggui; rose from carrying coffin-poles to owning several funeral-pole yards (ch.32)	花中桂之父；杠房抬杠出身，如今大发财，开了几处杠房（第32回）。
...
// Relationships live in their own module: one entry per character pair.
