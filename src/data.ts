...
char-141	屈道翁 Qū Dàowēng	道翁 / 道生 / Master Qu / 屈才爷 Qū Cáiye / Qu / 屈方正 Qū Fāngzhèng / 屈本立 Qū Běnlì / Qu Benli	—	—	scholar	ch.7	Senior scholar known as Qu Benli (calligraphy, ch.7), Qu Daoweng (main name), Qu Caiye (ch.56), and Qu Fangzheng (divine aspect); adopts Qinxian; dies in Nanjing (ch.56); shrine and dream arcs (ch.59–60)	名士屈道翁（亦以屈本立、屈才爷、屈方正等名出现）：第7回署名书法，第56回被称为屈才爷，后段收养琴仙，殁于南京，第59–60回托梦、建祠并入选十二花神。
