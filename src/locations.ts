...
export const novelLocations: NovelLocation[] = [
  ...
  { id: 'region-capital', name: '京师 / 京城', nameEn: 'Capital (Beijing)', type: 'place', typeZh: '地方', searchTokens: ['京城', '京师', '京中', '都中'], aliasesEn: ['Capital', 'Capital City'] },
  ...
  { id: 'city-beijing', name: '北京 / 京城', nameEn: 'Beijing', type: 'place', typeZh: '地方', searchTokens: ['京城', '京师', '京中', '都中', '北京'], aliasesEn: ['Beijing', 'Capital'] },
  ...
  { id: 'city-yangzhou', name: '扬州 / 广陵', nameEn: 'Yangzhou', type: 'place', typeZh: '地方', searchTokens: ['扬州', '广陵', '维扬'], aliasesEn: ['Yangzhou', 'Guangling', 'Weiyang'] },
  { id: 'city-suzhou', name: '苏州 / 姑苏', nameEn: 'Suzhou', type: 'place', typeZh: '地方', searchTokens: ['苏州', '姑苏', '吴郡'], aliasesEn: ['Suzhou', 'Gusu'] },
  ...
  { id: 'gate-qianmen', name: '前门 / 正阳门', nameEn: 'Front Gate (Zhengyangmen)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['正阳门', '前门'], aliasesEn: ['Zhengyang Gate', 'Qianmen'] },
  ...
  { id: 'temple-qu', name: '屈公祠 / 屈祠', nameEn: 'Qu Shrine', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['屈公祠堂', '屈公祠', '屈子祠', '屈祠'], aliasesEn: ['Qu Shrine', 'Shrine of Qu Daosheng'] },
