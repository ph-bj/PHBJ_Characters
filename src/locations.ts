...
export const novelLocations: NovelLocation[] = [
  ...
  { id: 'garden-sanle', name: '三乐园', nameEn: 'Three Joys Garden', type: 'garden', typeZh: '园林', searchTokens: ['三乐园'], aliasesEn: ['Sanle Garden'] },
  ...
  { id: 'feature-shaoyao', name: '芍药圃', nameEn: 'Peony Garden', type: 'garden', typeZh: '园林', searchTokens: ['芍药圃'], aliasesEn: ['Herbaceous Peony Beds'] },
  ...
  { id: 'feature-liuqing', name: '留青精舍', nameEn: 'Quiet-Green Lodge', type: 'garden', typeZh: '园林', searchTokens: ['留青精舍', '留青舍'], aliasesEn: ['Quiet Green Lodge', 'Green Lodge', 'Quiet-Green Retreat', 'Green Retreat'] },
  ...
  { id: 'street-fangli', name: '坊里', nameEn: 'Ward office (fangli)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['坊里', '坊官'], aliasesEn: ['ward office', 'ward officials'] },
  ...
  { id: 'office-bingmasi', name: '兵马司', nameEn: 'Beijing Ward Office', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['兵马司'], aliasesEn: ['ward office', 'Ward Office'] },
