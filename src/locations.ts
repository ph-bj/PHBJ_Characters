...
export const novelLocations: NovelLocation[] = [
  ...
  { id: 'city-jining', name: '济宁州', nameEn: 'Jining Department', type: 'place', typeZh: '地方', searchTokens: ['济宁州', '济宁'] },
  ...
  { id: 'city-jiaying', name: '嘉应州', nameEn: 'Jiaying Department', type: 'place', typeZh: '地方', searchTokens: ['嘉应州'] },
  ...
  { id: 'county-wuwei', name: '无为州', nameEn: 'Wuwei Department', type: 'place', typeZh: '地方', searchTokens: ['无为州'] },
  ...
  { id: 'garden-liang', name: '梁园', nameEn: 'Liang Garden (allusion)', type: 'allusion', typeZh: '典故', searchTokens: ['梁园'] },
  { id: 'garden-sanle', name: '三乐园', nameEn: 'Three Joys Theater', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['三乐园'], aliasesEn: ['Sanle Theater', 'Three Joys Playhouse'] },
  ...
  { id: 'site-shizilin', name: '狮子林', nameEn: 'Lion Grove Garden, Suzhou (allusion)', type: 'allusion', typeZh: '典故', searchTokens: ['狮子林'], aliasesEn: ['Lion Grove'] },
  ...
  { id: 'feature-mudan', name: '牡丹香国', nameEn: 'Kingdom of Tree-Peony Fragrance', type: 'garden', typeZh: '园林', searchTokens: ['牡丹香国'] },
  { id: 'feature-mudantai', name: '牡丹台', nameEn: 'Tree-Peony Terrace', type: 'garden', typeZh: '园林', searchTokens: ['牡丹台'] },
  ...
  { id: 'feature-liuqing', name: '留青精舍', nameEn: 'Stay-Green Studio', type: 'garden', typeZh: '园林', searchTokens: ['留青精舍', '留青舍'], aliasesEn: ['Quiet Green Lodge', 'Green Lodge', 'Quiet-Green Retreat', 'Green Retreat'] },
  ...
  { id: 'office-bingmasi', name: '兵马司', nameEn: 'Five Wards Office (gendarmerie)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['兵马司'], aliasesEn: ['Wuchengbingmasi', 'Five Wards Office'] },
