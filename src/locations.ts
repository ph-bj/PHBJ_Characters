...
export const novelLocations: NovelLocation[] = [
  ...
  { id: 'city-baoding', name: '保定府', nameEn: 'Baoding Prefecture', type: 'place', typeZh: '地方', searchTokens: ['保定府', '保定'], aliasesEn: ['Baoding'] },
  { id: 'city-jining', name: '济宁州', nameEn: 'Jining Department', type: 'place', typeZh: '地方', searchTokens: ['济宁州', '济宁'], aliasesEn: ['Jining Prefecture'] },
  ...
  { id: 'city-jiaying', name: '嘉应州', nameEn: 'Jiaying Department', type: 'place', typeZh: '地方', searchTokens: ['嘉应州'], aliasesEn: ['Jiaying Prefecture'] },
  { id: 'city-quzhou', name: '夔州府', nameEn: 'Kuizhou Prefecture', type: 'place', typeZh: '地方', searchTokens: ['夔州府', '夔州'], aliasesEn: ['Kuizhou'] },
  ...
  { id: 'garden-duxiang', name: '度香园', nameEn: 'Duxiang Garden', type: 'garden', typeZh: '园林', searchTokens: ['度香园'], aliasesEn: ['Duxiang Garden'] },
  { id: 'garden-liang', name: '梁园', nameEn: 'Liang Garden', type: 'allusion', typeZh: '典故', searchTokens: ['梁园'] },
  { id: 'garden-sanle', name: '三乐园', nameEn: 'Three Joys Theater', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['三乐园'], aliasesEn: ['Sanle Garden', 'Sanle Theater', 'Three Joys Garden', 'Three Joys Playhouse'] },
  { id: 'garden-derelict', name: '废园', nameEn: 'Derelict Garden', type: 'garden', typeZh: '园林', searchTokens: ['废园'], aliasesEn: ['ruined garden'] },
  { id: 'garden-little-rainbow', name: '小虹园', nameEn: 'Little Rainbow Garden', type: 'garden', typeZh: '园林', searchTokens: ['小虹园'], aliasesEn: ['Lesser Rainbow Garden'] },
  { id: 'garden-great-rainbow', name: '大虹园', nameEn: 'Great Rainbow Garden', type: 'garden', typeZh: '园林', searchTokens: ['大虹园'], aliasesEn: ['Greater Rainbow Garden'] },
  ...
  { id: 'feature-ruizhu', name: '蕊珠仙府', nameEn: 'Palace of the Petal Immortal', type: 'garden', typeZh: '园林', searchTokens: ['蕊珠仙府'], aliasesEn: ['Immortal Mansion of the Pearl of Stamens'] },
  { id: 'feature-qingliang', name: '清凉诗境', nameEn: 'Cool Poetic Realm', type: 'garden', typeZh: '园林', searchTokens: ['清凉诗境'], aliasesEn: ['Cool and Tranquil Poetic Realm', 'Poetic Realm'] },
  { id: 'feature-jicuixuan', name: '积翠轩', nameEn: 'Accumulated-Green Pavilion', type: 'garden', typeZh: '园林', searchTokens: ['积翠轩'], aliasesEn: ['Accumulated Kingfisher Pavilion'] },
  ...
  { id: 'feature-shaoyao', name: '芍药圃', nameEn: 'Herbaceous Peony Beds', type: 'garden', typeZh: '园林', searchTokens: ['芍药圃'], aliasesEn: ['Herbaceous Peony Beds'] },
  ...
  { id: 'feature-liuqing', name: '留青精舍', nameEn: 'Quiet-Green Retreat', type: 'garden', typeZh: '园林', searchTokens: ['留青精舍', '留青舍'], aliasesEn: ['Quiet-Green Lodge', 'Quiet Green Lodge', 'Quiet-Green Studio', 'Green Lodge', 'Green Retreat', 'Stay-Green Studio'] },
  { id: 'feature-xiaopingshan', name: '小平山', nameEn: 'Little Level Mountain (West Garden)', type: 'garden', typeZh: '园林', searchTokens: ['小平山'], aliasesEn: ['Xiaoping Mountain'] },
  { id: 'feature-dongfeng', name: '东风昨夜楼', nameEn: 'Last-Night East Wind Tower', type: 'garden', typeZh: '园林', searchTokens: ['东风昨夜楼'], aliasesEn: ['East-Wind-Last-Night Tower', 'Last-Night East Wind Tower'] },
  ...
  { id: 'feature-fenglu', name: '风露清吟馆', nameEn: 'Wind-and-Dew Poetry Hall', type: 'garden', typeZh: '园林', searchTokens: ['风露清吟馆'], aliasesEn: ['Lodge of Pure Chanting in Wind and Dew'] },
  { id: 'feature-juqi', name: '菊畦', nameEn: 'Chrysanthemum Plot', type: 'garden', typeZh: '园林', searchTokens: ['菊畦'], aliasesEn: ['Chrysanthemum Beds'] },
  { id: 'feature-huangxiang', name: '黄香东圃', nameEn: 'Eastern Garden of Yellow Fragrance', type: 'garden', typeZh: '园林', searchTokens: ['黄香东圃'] },
  { id: 'feature-songkan', name: '松龛', nameEn: 'Pine Niche', type: 'garden', typeZh: '园林', searchTokens: ['松龛'], aliasesEn: ['Pine Shrine'] },
  { id: 'feature-songhe', name: '松鹤丹房', nameEn: 'Pine-and-Crane Alchemical Lodge', type: 'garden', typeZh: '园林', searchTokens: ['松鹤丹房'], aliasesEn: ['Cinnabar Chamber of Pine and Crane'] },
  { id: 'feature-guxiang', name: '古香林屋', nameEn: 'Ancient-Fragrance Forest House', type: 'garden', typeZh: '园林', searchTokens: ['古香林屋'], aliasesEn: ['Ancient-Fragrance Woodland Lodge'] },
  { id: 'feature-woyun', name: '卧云香院', nameEn: 'Fragrant Court of Resting Clouds', type: 'garden', typeZh: '园林', searchTokens: ['卧云香院'], aliasesEn: ['Fragrant Court of Reclining Clouds'] },
  { id: 'feature-yinqiu', name: '吟秋榭', nameEn: 'Autumn-Chanting Waterside Pavilion', type: 'garden', typeZh: '园林', searchTokens: ['吟秋榭', '吟秋水榭'], aliasesEn: ['Autumn-Chant Waterside Pavilion'] },
  { id: 'feature-tingyun', name: '停云叙雨轩', nameEn: 'Studio of Lingering Clouds and Speaking Rain', type: 'garden', typeZh: '园林', searchTokens: ['停云叙雨轩'], aliasesEn: ['Pavilion of Halted Cloud and Told Rain'] },
  ...
  { id: 'feature-guiling', name: '桂岭', nameEn: 'Osmanthus Ridge', type: 'garden', typeZh: '园林', searchTokens: ['桂岭'], aliasesEn: ['Osmanthus Ridge'] },
  { id: 'feature-conggui', name: '丛桂山房', nameEn: 'Osmanthus Grove Mountain Lodge', type: 'garden', typeZh: '园林', searchTokens: ['丛桂山房'], aliasesEn: ['Osmanthus Grove Mountain Lodge'] },
  { id: 'feature-piaomiao', name: '缥渺亭', nameEn: 'Mist-Veiled Pavilion', type: 'garden', typeZh: '园林', searchTokens: ['缥渺亭'], aliasesEn: ['Pavilion of Faint Mist'] },
  { id: 'feature-taohuawu', name: '桃花坞', nameEn: 'Peach-Blossom Dell', type: 'garden', typeZh: '园林', searchTokens: ['桃花坞'], aliasesEn: ['Peach Blossom Dell'] },
  { id: 'feature-xunyuan', name: '寻源仙墅', nameEn: 'Immortal Retreat of Seeking the Source', type: 'garden', typeZh: '园林', searchTokens: ['寻源仙墅'], aliasesEn: ['Seeking-the-Source Immortal Villa'] },
  { id: 'feature-xiaochicheng', name: '小赤城', nameEn: 'Little Red Citadel', type: 'garden', typeZh: '园林', searchTokens: ['小赤城'] },
  { id: 'feature-daozhuang', name: '稻庄', nameEn: 'Rice-Farm Hamlet', type: 'garden', typeZh: '园林', searchTokens: ['稻庄'], aliasesEn: ['Rice Farm'] },
  { id: 'feature-hongxue', name: '红雪西庄', nameEn: 'Western Hamlet of Red Snow', type: 'garden', typeZh: '园林', searchTokens: ['红雪西庄'], aliasesEn: ['Red Snow West Manor'] },
  { id: 'feature-shepu', name: '射圃', nameEn: 'Archery Ground', type: 'garden', typeZh: '园林', searchTokens: ['射圃'], aliasesEn: ['archery ground'] },
  { id: 'feature-yuzhuang', name: '渔庄', nameEn: 'Fishing Hamlet', type: 'garden', typeZh: '园林', searchTokens: ['渔庄'], aliasesEn: ['fishing hamlet'] },
  ...
  { id: 'residence-mei', name: '梅宅', nameEn: 'Mei residence', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['梅宅', '梅府', '梅家'], aliasesEn: ['Mei house', 'Mei family', 'Mei Residence'] },
  ...
  { id: 'street-xiawazi', name: '下洼子', nameEn: 'Xiawazi', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['下洼子'], aliasesEn: ['Low Hollow'] },
  ...
  { id: 'street-fangli', name: '坊里', nameEn: 'Neighbourhood ward (fangli)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['坊里', '坊官'], aliasesEn: ['ward office', 'ward officials'] },
  ...
  { id: 'venue-qiushui', name: '秋水堂', nameEn: 'Qiushui Hall', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['秋水堂'], aliasesEn: ['Autumn Water Hall', 'Qiushui Hall'] },
  { id: 'venue-tianxianglou', name: '天香楼', nameEn: 'Tianxiang Tower', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['天香楼'], aliasesEn: ['Tianxiang Pavilion'] },
  { id: 'venue-feicui', name: '翡翠楼', nameEn: 'Feicui Tower', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['翡翠楼'], aliasesEn: ['Jade Tower', 'Jade Pavilion'] },
  { id: 'venue-chunyang', name: '春阳馆', nameEn: 'Chunyang House', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['春阳馆'], aliasesEn: ['Chunyang Restaurant'] },
  { id: 'venue-gusu', name: '姑苏会馆', nameEn: 'Gusu Guild Hall (Beijing)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['姑苏会馆'], aliasesEn: ['Suzhou Guild Hall'] },
  ...
  { id: 'venue-fuyin', name: '府尹', nameEn: 'Prefectural Office', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['府尹'], aliasesEn: ['prefectural magistrate'] },
  ...
  { id: 'temple-flower', name: '花神庙', nameEn: 'Flower-Deity Shrine', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['花神庙'], aliasesEn: ['temple of the Flower Goddess'] },
  { id: 'site-baonensi', name: '大报恩寺', nameEn: "Grand Bao'en Temple (Nanjing)", type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['大报恩寺', '报恩寺'], aliasesEn: ['Baoen Temple', 'Bao\'en Temple'] },
  { id: 'street-jinpailou', name: '金牌楼', nameEn: 'Golden Archway', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['金牌楼'], aliasesEn: ['Golden Archway'] },
  { id: 'street-nanheng', name: '南横街', nameEn: 'South Cross Street', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['南横街'], aliasesEn: ['Nanheng Street'] },
  { id: 'street-yangliu', name: '杨柳巷', nameEn: 'Willow Lane', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['杨柳巷'], aliasesEn: ['Yangliu Lane'] },
  { id: 'street-yingtao', name: '樱桃巷', nameEn: 'Cherry Lane', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['樱桃巷'], aliasesEn: ['Cherry Lane'] },
  { id: 'street-yanzhi', name: '胭脂巷', nameEn: 'Rouge Lane', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['胭脂巷'], aliasesEn: ['Rouge Lane'] },
  { id: 'venue-anji', name: '安吉堂', nameEn: 'Anji Hall', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['安吉堂'] },
  { id: 'venue-liuhe', name: '六合馆', nameEn: 'Liuhe House', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['六合馆'], aliasesEn: ['Six Harmonies Inn'] },
  { id: 'venue-guxiu', name: '古秀斋', nameEn: 'Guxiu Studio', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['古秀斋'], aliasesEn: ['Guxiuzhai'] },
  { id: 'venue-juxing', name: '聚星堂', nameEn: 'Hall of Gathered Stars', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['聚星堂'], aliasesEn: ['Gathering Stars Hall'] },
  { id: 'office-bingmasi', name: '兵马司', nameEn: 'Five Wards Office (gendarmerie)', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['兵马司'], aliasesEn: ['Wuchengbingmasi', 'Five Wards Office', 'ward office'] },
  { id: 'office-xingbu', name: '刑部', nameEn: 'Ministry of Punishments', type: 'site', typeZh: '府邸街巷与场馆', searchTokens: ['刑部'], aliasesEn: ['Ministry of Punishments'] },

  // —— Rivers, mountains & landmarks (travel scenes & natural sites) ——
  { id: 'site-mochou', name: '莫愁湖', nameEn: 'Mochou Lake (Nanjing)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['莫愁湖'], aliasesEn: ['Mochou Lake'] },
  { id: 'site-xuanwuhu', name: '玄武湖', nameEn: 'Lake Xuanwu (Nanjing)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['玄武湖'], aliasesEn: ['Xuanwu Lake'] },
  { id: 'site-pingshan', name: '平山堂', nameEn: 'Pingshan Hall (Yangzhou)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['平山堂'], aliasesEn: ['Pingshan Hall'] },
  { id: 'site-yanziji', name: '燕子矶', nameEn: 'Swallow Bluff (Nanjing)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['燕子矶'], aliasesEn: ['Swallow Bluff'] },
  { id: 'site-rainbow-bridge', name: '虹桥', nameEn: 'Rainbow Bridge (Yangzhou)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['虹桥'], aliasesEn: ['Rainbow Bridge'] },
  { id: 'site-lotus-bridge', name: '莲花桥', nameEn: 'Lotus Bridge (Yangzhou)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['莲花桥'], aliasesEn: ['Lotus Bridge'] },
  { id: 'site-hanxi-gate', name: '旱西门', nameEn: 'Hanxi Gate (Nanjing)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['旱西门'], aliasesEn: ['Hanxi Gate'] },
  ...
  { id: 'water-taihu', name: '太湖', nameEn: 'Lake Tai (Taihu)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['太湖'], aliasesEn: ['Lake Tai', 'Tai Lake'] },
  { id: 'mountain-phoenix', name: '凤凰山', nameEn: 'Phoenix Mountain (Nanjing)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['凤凰山'], aliasesEn: ['Phoenix Mountain'] },
  ...
  { id: 'water-guazhou', name: '瓜州', nameEn: 'Guazhou Crossing', type: 'landscape', typeZh: '山水名胜', searchTokens: ['瓜州'], aliasesEn: ['Guazhou'] },
  { id: 'water-zhangjiawan', name: '张家湾', nameEn: 'Zhangjiawan', type: 'landscape', typeZh: '山水名胜', searchTokens: ['张家湾'] },
  { id: 'water-wangjiaying', name: '王家营', nameEn: 'Wangjiaying Crossing', type: 'landscape', typeZh: '山水名胜', searchTokens: ['王家营', '王家营子'], aliasesEn: ['Wangjiaying'] },
  { id: 'gate-longjiang', name: '龙江关', nameEn: 'Longjiang Customs Station', type: 'landscape', typeZh: '山水名胜', searchTokens: ['龙江关'], aliasesEn: ['Longjiang checkpoint'] },
  { id: 'gate-shuixi', name: '水西关', nameEn: 'Shuixi Gate', type: 'landscape', typeZh: '山水名胜', searchTokens: ['水西门', '水西关'], aliasesEn: ['Water-West Gate'] },
  { id: 'bridge-fuhu', name: '伏虎桥', nameEn: 'Fuhu Bridge', type: 'landscape', typeZh: '山水名胜', searchTokens: ['伏虎桥'] },
  { id: 'mountain-dongting', name: '洞庭山', nameEn: 'Dongting Mountain (Lake Tai)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['洞庭山'], aliasesEn: ['Dongting Mountain'] },
  ...
  { id: 'water-pengli', name: '彭蠡', nameEn: 'Pengli (Poyang Lake)', type: 'landscape', typeZh: '山水名胜', searchTokens: ['彭蠡'], aliasesEn: ['Poyang'] },
  ...
  { id: 'allusion-penglai', name: '蓬莱', nameEn: 'Penglai, Isles of the Immortals', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['蓬莱', '蓬山'], aliasesEn: ['Penglai', 'Mount Penglai'] },
  { id: 'allusion-yaotai', name: '瑶台', nameEn: 'Jade Terrace', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['瑶台'], aliasesEn: ['Jasper Terrace'] },
  { id: 'allusion-yujing', name: '玉京', nameEn: 'Jade Capital of the Immortals', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['玉京'], aliasesEn: ['Jade Capital'] },
  { id: 'allusion-moon-palace', name: '月宫', nameEn: 'Moon Palace', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['月宫', '月殿', '广寒'] },
  { id: 'allusion-luopu', name: '洛浦', nameEn: 'Luo River Banks', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['洛浦'], aliasesEn: ['Luo River'] },
  { id: 'allusion-wushan', name: '巫山', nameEn: 'Mount Wu', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['巫山', '巫峰'], aliasesEn: ['Mount Wu'] },
  ...
  { id: 'allusion-three-mountains', name: '三山', nameEn: 'Three Isles of the Immortals', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['三山'], aliasesEn: ['three mountains'] },
  { id: 'allusion-yantai', name: '燕台', nameEn: 'Yan Terrace', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['燕台'], aliasesEn: ['Yantai'] },
  ...
  { id: 'allusion-jingu', name: '金谷', nameEn: 'Jingu Garden', type: 'allusion', typeZh: '典故与想象地理', searchTokens: ['金谷'], aliasesEn: ['Golden Valley'] },
