...
const chapterCounts = [
  8516, 9059, 9190, 7870, 8052, 8824, 8928, 8734, 8043, 8139,
  7937, 8073, 9345, 8135, 8038, 8106, 7835, 6937, 7778, 8162,
  6769, 9404, 6599, 6640, 8410, 7489, 9152, 8150, 7940, 7708,
  8160, 7361, 8555, 9342, 9881, 9421, 8658, 9309, 8266, 9232,
...
export const question: QuestionDefinition = {
  ...
  answerEn: `The current bundled Chinese corpus contains **512,896 Unicode code points**, counting punctuation and other characters after joining the paragraph strings. This is a corpus count, not a universal count for every historical edition.

${countLinesEn}`,
  answerZh: `当前项目捆绑的中文语料合计 **512,896 个 Unicode 字符**，统计时将各段落连接后计入标点及其他字符。这是本项目语料的统计值，并不代表所有历史版本都具有相同字数。
