...
export const question: QuestionDefinition = {
  ...
  questionEn:
    "What is the story's overall time span, and which key moments on the timeline correspond to which plot developments?",
  questionZh:
    "整个故事的时间跨度是怎么样的？有哪些关键的时间节点对应怎么样的故事剧情？",
  answerZh: `### 先说结论：主线约跨两个年头，再延伸到第三年三月
...
全书大体走过**两个冬天、两个春天，并在第三个春天完成结局**。季节变化并非单纯报时：第一个冬天是“初见”，第一个春夏是“生情与受阻”；第二年元宵至春末是“受辱、脱籍与离别”，夏秋是“死亡与考验”，第二个岁末是“归来”；第三年春天则以焚烧旧物完成“重生”。因此，小说的真正终点不是子玉与琴仙简单团聚，而是琴仙及同伴获得新的社会身份和叙述权。`,
  answerEn: `### In brief: about two years, ending in the third year's third lunar month
...
The plot passes through **two winters and two springs, then concludes in a third spring**. The first winter brings encounter; the first spring and summer bring attachment and obstruction; the second year's spring brings humiliation, emancipation, and departure; summer and autumn bring death and trial; winter brings return; and the third spring completes rebirth. The ending is therefore more than a reunion between Ziyu and Qinxian: it marks Qinxian and his companions acquiring new social identities and the authority to name themselves.`,
};
