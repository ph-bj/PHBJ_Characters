...
export const summaryGists: Record<number, ChapterGists> = {
  ...
  46: {
    zh: [
      ...
      `二十八日众人遍游全园，一路改名题联：含万楼改作赐书楼并亲题长联，承荫堂添了两副，戏台前的匾额由子玉题成，道翁赞道"我说庚香世兄定是不凡的"。`,
  ...
  48: {
    zh: [
      ...
      `琴仙取出《怡园饯别图》扇子，子云已填了半阕《金缕曲》，子玉和其韵；念到"只道今生长厮守……谁又想，境更换"琴仙放声大哭，泪把词稿滴湿了一半。初六日袁琪官单请话别，说起同来的十个人如今只剩两个，三人同哭。`,
