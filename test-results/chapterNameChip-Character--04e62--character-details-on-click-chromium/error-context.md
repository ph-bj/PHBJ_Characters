...
- Name: chapterNameChip.spec.ts >> Character Name Chip Verification >> should render "Yaoqing" as a name chip in Chapter 31 (English translation) and open character details on click
- Location: tests/chapterNameChip.spec.ts:36:3
...
Locator: locator('button.align-baseline:has-text("Yaoqing")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button.align-baseline:has-text("Yaoqing")').first()
