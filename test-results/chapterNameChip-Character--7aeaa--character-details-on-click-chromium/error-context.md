...
- Name: chapterNameChip.spec.ts >> Character Name Chip Verification >> should render "贵大" as a name chip in Chapter 3 and open character details on click
- Location: tests/chapterNameChip.spec.ts:20:3
...
Locator: locator('button.align-baseline:has-text("贵大")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button.align-baseline:has-text("贵大")').first()
